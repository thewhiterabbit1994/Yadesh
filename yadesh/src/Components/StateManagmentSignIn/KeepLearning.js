...
const KeepLearning = () => {
  ...
  const handleClick = () => {
    ...
    database.HomePageLogin.ContinueLearning.title = titleValue;
    database.HomePageLogin.ContinueLearning.subTitle = subtitleValue;
    database.HomePageLogin.ContinueLearning.isDisplayed = toggle;
