    ...
    return (
        <section className="w-full h-[300px] bg-[#F5F5F5] mt-[10px] rounded flex justify-between">
            ...
            <section className="w-[50%]">
                <div className="my-[30px] text-[12px]">
                    <label
                        className="text-[12px] w-[400px] text-[#7A7A7A] mb-[15px] pr-[10px]"
                        htmlFor="search4">
                        لوگوی مشتری (فرمت مورد نظر png یا svg  می باشد )
                    </label>
                    <section className="flex w-[500px]">
                        <input
                            id="search4"
                            className="w-[300px] h-[40px] mt-[20px] rounded placeholder:w-[200px]  placeholder:text-[11px] placeholder:pr-[10px]"
                            placeholder="melat-bank-logo.png "
                        />

                        <button className="w-[100px] h-[40px] mt-[20px] rounded text-[#fff]  text-[10px] bg-[#008043]">جستجو فایل</button>
                    </section>
                </div>
