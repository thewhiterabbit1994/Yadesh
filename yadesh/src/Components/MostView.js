    ...
    return (
        <div className="w-full h-[100vh] bg-[#000]">
            ...
            <section className="w-full h-[420px] flex mt-[2rem] justify-center ">
                ...
                <div className="flex flex-wrap w-full  h-[460px] ml-[115px] ">
                    <div className="text-[#E6FFF3] ml-[25px] ">
                        <img src={CultureBuilding} className="rounded w-[175px] h-[120px]" />
                    ...
                    <div className=" text-[#E6FFF3] text-[11px] ml-[25px]">
                        <img src={PsychologyOfColors} className="rounded  w-[175px] h-[120px]" />
                        <div className="leading-7 mt-[.5rem] ">
                            <h6 className="text-[12px]"> فرهنگ سازمانی - مدیریت محیط</h6>
                            <h6 className="text-[10px] text-[#C4C4C4]"> 20 دقیقه و 12 ثانیه  . 2330 بازدید</h6>
                        </div>
                    ...
                    <div className=" text-[#E6FFF3] text-[11px] ml-[25px] ">
                        <img src={RealEstateInvesting} className="rounded  w-[175px] h-[120px]" />
                        <div className="leading-7 mt-[.5rem] ">
                            <h6 className="text-[12px]"> فرهنگ سازمانی - مدیریت محیط</h6>
                            <h6 className="text-[10px] text-[#C4C4C4]"> 20 دقیقه و 12 ثانیه  . 2330 بازدید</h6>
                        </div>
                    ...
                    <div className=" text-[#E6FFF3] text-[11px] ">
                        <img src={PersonalBranding} className=" w-[175px] h-[120px] rounded  " />
                        <div className="leading-7 mt-[.5rem] ">
                            <h6  className="text-[12px]"> فرهنگ سازمانی - مدیریت محیط</h6>
                            <h6 className="text-[10px] text-[#C4C4C4]"> 20 دقیقه و 12 ثانیه  . 2330 بازدید</h6>
                        </div>
