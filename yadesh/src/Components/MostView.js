...
const MostView = () => {
    return (
        <div className="w-[100%] h-[100vh] bg-[#000]">
            <section className=" w-[266px] flex flex-col items-center">
                <div className="flex w-[266px]  justify-start mr-[20px]">
            ...
            <section className="w-[100%] h-[557px] flex mt-[2rem] justify-center">
                ...
                <div className="flex flex-wrap w-[750px] h-[460px]">
                    <div className="text-[#E6FFF3] text-[11px] mb-[15px] ml-[10px] ">
