      ...
      <section className="w-[80%] bg-[#000E14] h-[41vh] flex rounded mb-[2rem]">
        <section className="w-[65%] flex flex-col  h-[100%] items-center justify-center ">
          <div className="text-[#E6FFF3] text-[14px] flex w-[75%] mb-[2rem]">
            <div className="border-[#00FF85] opacity-80  border-r-[4px] ml-[7px] rounded-[6px] ">
              {" "}
            </div>
            <h6> پلن سازمانی</h6>
          </div>
          <div className="text-[#E6FFF3] text-[14px] leading-10 opacity-70">
            <h6 className="w-[500px]">
          ...
          <div className="mt-[2rem]  w-[75%]">
            <button className="text-[12px] text-[#E6FFF3] w-[7.5rem] h-[2.5rem] rounded border-solid border-[#00FF85] border-2 ml-[7px] ">
              {" "}
              بیشتر بدانید
            </button>
          </div>
        ...
        <section className="w-[30%] relative flex">
          <div>
            <img
              ...
              className="w-[300px] h-[250px] rounded absolute top-[-26px]"
            />
          </div>
        </section>
      </section>
