...
const Header = () => {
    return (
        <section className="w-full h-[550px] relative bg-[#000]">
            <section >
                <img src={imgAboutUs} className="w-[100%] h-[450px]" />
            ...
            <section className="absolute top-[15%] right-[45%] flex mt-[30px]">
                ...
                <div className="absolute top-[50px] left-[-270px] w-[600px] text-center  m-auto">
                    <h6 className="text-[#E6FFF3] text-[36px]">یادش را بشناسید</h6>
                    <h6 className="text-[#C4C4C4] text-[16px] mt-[20px] w-[400px] text-center m-auto leading-[35px]">یادش بزرگترین پلتفرم ویدئویی آموزشی برای شرکت ها افراد و مدیران تولید میباشد</h6>
                </div>
