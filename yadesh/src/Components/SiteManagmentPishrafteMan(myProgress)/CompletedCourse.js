...
const CompletedCourse = () => {
  ...
  const handleClick = () => {
    ...
    database.MyProgress.DoneCourses.title = titleValue;
    database.MyProgress.DoneCourses.subTitle = subtitleValue;
    database.MyProgress.DoneCourses.isDisplayed = toggle;
