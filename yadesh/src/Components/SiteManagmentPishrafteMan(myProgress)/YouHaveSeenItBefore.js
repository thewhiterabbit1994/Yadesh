...
const YouHaveSeenItBefore = () => {
  ...
  const handleClick = () => {
    ...
    database.MyProgress.SeenBefore.title = titleValue;
    database.MyProgress.SeenBefore.subTitle = subtitleValue;
    database.MyProgress.SeenBefore.isDisplayed = toggle;
...
export default YouHaveSeenItBefore;
