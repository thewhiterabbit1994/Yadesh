...
const AddCourse = ({ EditCourseModal, setEditCourseModal }) => {
    ...
    return (
        ...
        <section
            className={`fixed transform transition-opacity duration-300 scale-0 z-50 w-full h-screen mt-[-200px] bg-[#00000071]  ${EditCourseModal ? "scale-100 opacity-100" : "opacity-0 "
                }`}
        >
            <section
