...
const AddNewSubscription = ({ ModalNewSubscription, setModalNewSubscription }) => {
    ...
    return (
        ...
        <section
            className={`fixed transform transition-opacity duration-300 scale-0 z-50 w-full h-screen mt-[-100px] bg-[#00000071]  ${ModalNewSubscription ? "scale-100 opacity-100" : "opacity-0 "
                }`}
        >
            <section
