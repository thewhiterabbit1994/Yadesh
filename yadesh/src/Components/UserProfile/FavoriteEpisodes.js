  ...
  <div className="w-full h-fit bg-[#000405]">
    <div className="mr-[80px] pt-[20px]">
      <div className="flex ">
        ...
        <p className="text-[19px]  text-[#ffffff]">اپیزودهای مورد علاقه</p>
      </div>
      <div>
        <p className="mt-[15px] text-[#C4C4C4] text-[14px]">
          لیست اپیزودهای مورد علاقه شما
        </p>
      </div>
    </div>
    <div className="w-[100%] flex flex-wrap justify-center px-[80px] mt-[25px]">
