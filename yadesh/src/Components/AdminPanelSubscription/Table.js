    ...
    <section className="w-[97vw]">
      ...
      <section className="w-[87%] mr-[120px] m-auto text-[12px] text-[#001D29]">
        <section className="w-full justify-between flex py-[20px]  items-center  bg-[#e6e9eb6e]">
          <section className="w-[50%] font-semibold pr-[10px]">
            {" "}
            لیست اشتراک ها
          </section>
        ...
        <table class="table-auto w-full bg-[#e6e9eb6e] rounded text-[12px]">
          <thead>
            <tr className="text-[#000000e5] h-[50px]">
              ...
              <th>
                <p className="text-center">اشتراک</p>
              </th>
              <th>
                <p className="text-center">وضعیت</p>
              </th>
              <th>
                <p className="text-center">مبلغ</p>
              </th>
              <th>
                <p className="text-center">تعداد کاربران</p>
              </th>
              <th>
                <p className="text-center">تاریخ تمدید</p>
              </th>
              <th></th>
              <th></th>
            </tr>
                    ...
                    <tr className="h-[50px] hover:bg-[#e6e9ebc2]">
                      ...
                      <td>
                        <p
                          ...
                          className="mr-[10px] text-[#0050A8] cursor-pointer text-center font-semibold"
                        >
                          جزییات اشتراک
                        </p>
                      </td>
                      <td>
                        <p
                          ...
                          className={`mr-[10px] text-[#AA0029]   cursor-pointer text-center font-semibold`}
                        >
                          لغو اشتراک
                        </p>
                      </td>
        ...
        <section
          ...
          className="w-full mt-[20px] cursor-pointer h-[50px] bg-[#E6E9EB] flex justify-center rounded items-center"
        >
          <p>موارد بیشتر</p>
        </section>
      </section>
