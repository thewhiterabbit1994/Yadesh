...
export default () => {
  ...
  return (
    <>
      <div
        className={`${
          logoutModal ? "fixed flex z-50 h-screen w-screen bg-black" : "hidden"
        }`}
      >
        <LogOut setlogoutModal={setlogoutModal} />
      </div>
      <div className=" fixed shadow-xl drop-shadow-xl right-0 w-[70px] z-40 h-screen bg-[#f5f5f5]">
        <div
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-12">
            ...
            >
              ...
              >
                {location.pathname === "/admindashboard/listofcompanies" ||
                location.pathname === "/admindashboard/Listofcompanies" ||
                location.pathname === "/admindashboard/userlist" ||
                location.pathname ===
          ...
          <div className="mt-8">
            ...
            <section
              className={` ${
                settingsModal
                  ? "w-screen  fixed top-0 mr-[-25px] transform transition-opacity duration-300 h-screen  bg-[#00000034] scale-100 opacity-100"
                  : " opacity-0 scale-0"
              } `}
            >
              <div className="z-50 absolute w-screen inset-x-11 h-[500px] top-2">
                {settingsModal ? (
                  <Settings
