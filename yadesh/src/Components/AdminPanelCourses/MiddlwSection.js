                ...
                <section className="w-[42%] justify-between flex text-[10px] text-[#001D29]">
                    ...
                    <section className="w-[300px] rounded h-[50px] bg-[#008043] flex justify-around items-center">
                        <section className="flex">
                            <Create />
                            <p className="text-[10px] mr-[10px] text-[#fff]">افزودن شرکت های جدید</p>
                        </section>
                        <div className="tetx-[#001D29] text-[10px] font-semibold bg-[#fff] w-[80px] h-[40px] rounded flex justify-center items-center"> اضافه کنید</div>
                    </section>
                </section>
            </section>
        </section>
