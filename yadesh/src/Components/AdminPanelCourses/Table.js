        ...
        <section className="w-full">
            <section className="w-[90%] m-auto text-[12px] text-[#001D29] mr-[120px]">
                <section className="w-full justify-between flex  py-[20px] bg-[#e6e9eb6e] rounded-lg">
                    <section className="w-[50%] pr-[10px] font-semibold"> لیست دور های شما</section>
                    <section className="w-[600px] flex justify-between pl-[10px]">
                        <div className="flex text-[12px] w-[300px] h-[35px] bg-[#E6E9EB] rounded">
                            ...
                            <label className="z-30 w-[300px] h-[35px] flex">
                                <input placeholder="جستوجوی دوره ها " className="z-30 w-[100px] placeholder:text-[#000000a4] placeholder:text-[10px] bg-[#E6E9EB] outline-none" />
                            </label>
                        </div>
                ...
                <table class="table-auto w-full bg-[#e6e9eb6e]">
                    <thead>
                        <tr className="h-[50px]">
                            ...
                            <th><p className="text-center">تصویر دوره</p></th>
                            <th><p className="text-center">نام مدرس </p></th>
                            <th><p className="text-center">زمان دوره </p></th>
                            <th><p className="text-center">تعداد اپیزود</p></th>
                            ...
                            course.map((item) => {
                                return (
                                    <tr className="hover:bg-[#e6e9ebc2]">
                                        ...
                                        <td ><img src={item.img} className="rounded m-auto" /> </td>
                                        <td><p className="text-center">{item.teacherName}</p></td>
                                        <td><p className="text-center text-[#0050A8] font-semibold">{item.courseTime}</p></td>
                                        <td className="text-[#0050A8] font-semibold text-center">{item.NumberOfEpisodes}</td>
                                        <td><p className="text-center">{item.category}</p></td>
                                        <td className="flex items-center h-[80px]">
                                            <div className="mt-[3px]">
                                                <Edit />{" "}
                                            </div>
                                            <p className="mr-[10px] text-[#0050A8]  text-[10px]">ویراش شرکت ها</p>
                                        </td>
                                    </tr>
                                )
                            })
                ...
                <section className="w-full h-[50px] bg-[#E6E9EB] mt-[20px] flex justify-center items-center rounded-lg">
                    <p onClick={() => setShowmore(!showmore)} className="cursor-pointer ">موارد بیشتر</p>
                </section>
            </section >
        </section >
    );
