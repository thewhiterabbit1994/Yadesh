...
import imgUser from "../../assets/Img/AdminPanelCourses/imgUser.png"
            ...
            <section className="w-[85%] m-auto text-[12px] text-[#001D29]">
                ...
                <table id="customers">
                    <tr>
                        ...
                        <th><p className="text-center">عکس</p></th>
                        <th><p className="text-center">نام اپیزود </p></th>
                        <th><p className="text-center">نام و نام خانوادگی </p></th>
                        <th><p className="text-center">شرکت </p></th>
                        <th><p className="text-center"> شماره تلفن</p></th>
                        <th><p className="text-center"> ایمیل</p></th>

                    </tr>
                    <tr>
                        <td className="text-center">1</td>
                        <td ><img src={imgUser} className="rounded-[50%] m-auto" /> </td>
                        <td><p className="text-center">رضا رنجبر</p></td>
                        <td><p className="text-center">مخابرات ایران </p></td>
                        <td className="font-semibold text-center"> 021-88665544</td>
                        <td><p className="text-center">info@google.com</p></td>
